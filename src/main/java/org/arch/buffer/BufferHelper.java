...
public class BufferHelper {
	...
	public static void writeFixInt16(Buffer buffer, short v, boolean networkOrder) {
		if (networkOrder) {
	...
	private static <T> T readObject(Buffer buffer, Class<T> clazz) throws IOException {
	...
	public static <T> List<T> readList(Buffer buffer, Class<T> clazz) throws IOException {
	...
	public static <T> Set<T> readSet(Buffer buffer, Class<T> clazz) throws IOException {
