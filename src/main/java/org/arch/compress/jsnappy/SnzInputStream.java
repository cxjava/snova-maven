...
public class SnzInputStream extends FilterInputStream {
	...
	/**
	 * Fills the byte array with data from the uncompressed stream starting at the specified <code>offset</code> and no
	 * more than <code>length</code> bytes.
	 * 
	 * @param b
	 *            destination array
	 * @param offset
	 *            offset into the byte array, on which the data is written
