...
public class LZFInputStream extends InputStream {
	...
	/**
	 * Flag that indicates whether we force full reads (reading of as many bytes as requested), or 'optimal' reads (up
	 * to as many as available, but at least one). Default is false, meaning that 'optimal' read is used.
	 */
	 ...
	 * @param fullReads
	 *            Whether {@link #read(byte[])} should try to read exactly as many bytes as requested (true); or just
	 *            however many happen to be available (false)
	 */
