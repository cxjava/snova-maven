...
class Header {
	...
	/*
	 * Returns a representation of a decoded DNS message header. Does not modify or store a reference to the msg array.
	 */
	...
	/*
	 * Decodes a DNS message header. Does not modify or store a reference to the msg array.
	 */
